...
export const udoc_get_visibility_groups: (a: number, b: number, c: number, d: number) => void;
...
export const udoc_has_gpu: (a: number) => number;
export const udoc_init_gpu: (a: number) => number;
...
export const udoc_load_xlsx: (a: number, b: number, c: number, d: number) => void;
...
export const udoc_render_page_gpu: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
...
export const __wasm_bindgen_func_elem_2525: (a: number, b: number, c: number) => void;
export const __wasm_bindgen_func_elem_2509: (a: number, b: number) => void;
export const __wasm_bindgen_func_elem_16202: (a: number, b: number, c: number, d: number) => void;
