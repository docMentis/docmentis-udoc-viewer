...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_34700: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_34702: (a: number, b: number, c: number, d: number) => void;
