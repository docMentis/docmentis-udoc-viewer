            ...
            let cleanupAttrObserver: (() => void) | null = null;
            {
                ...
                if (showAttribution) {
                    const observer = new MutationObserver((mutations) => {
                        ...
                        if (!container.contains(indicatorStyle)) {
                            container.appendChild(indicatorStyle);
                        }

                        for (const mutation of mutations) {
                            if (mutation.target === indicator) {
                                if (
                            ...
                            if (mutation.target.parentNode === indicator && mutation.type === "characterData") {
                                needsRestore = true;
                            }
                        }
                    ...
                    cleanupAttrObserver = () => observer.disconnect();
                }
            }
