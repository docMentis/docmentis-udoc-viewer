...
export const de: TranslationKeys = {
    ...
    "tools.deleteAnnotation": "Anmerkung löschen",
    // Annotate sub-tools
    ...
    "tools.fillColor": "Füllfarbe",
    "tools.noFill": "Keine Füllung",
    "tools.strokeWidth": "Linienstärke",
    "tools.opacity": "Deckkraft",
    "tools.fontSize": "Schriftgröße",
